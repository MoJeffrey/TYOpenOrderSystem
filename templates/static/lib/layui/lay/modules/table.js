...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    E = ['<div class="layui-form layui-border-box {{d.VIEW_CLASS}}" lay-filter="LAY-table-{{d.index}}" lay-id="{{ d.data.id }}" style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">', "{{# if(d.data.toolbar){ }}", '<div class="layui-table-tool">', '<div class="layui-table-tool-temp"></div>', '<div class="layui-table-tool-self"></div>', "</div>", "{{# } }}", '<div class="layui-table-box">', "{{# if(d.data.loading){ }}", '<div class="layui-table-init" style="background-color: #fff;">', '<i class="layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop"></i>', "</div>", "{{# } }}", "{{# var left, right; }}", '<div class="layui-table-header">', W(), "</div>", '<div class="layui-table-body layui-table-main">', _, "</div>", "{{# if(left){ }}", '<div class="layui-table-fixed layui-table-fixed-l">', '<div class="layui-table-header">', W({
            fixed: !0
    ...
    F.prototype.render = function () {
        ...
        if (a.elem = t(a.elem), a.where = a.where || {}, a.id = a.id || a.elem.attr("id") || e.index, a.request = t.extend({
            ...
            return e;
        a.height && /^full-\d+$/.test(a.height) && (e.fullHeightGap = a.height.split("-")[1], a.height = z.height() - e.fullHeightGap),
        e.setInit();
        var l = a.elem,
        n = l.next("." + v),
    ...
    F.prototype.sort = function (e, i, a, l) {
        ...
        try {
            ...
            if (c.sortKey && !a && n === c.sortKey.field && i === c.sortKey.sort)
                return;
            var v = c.layHeader.find("th .laytable-cell-" + p).find(H);
            c.layHeader.find("th").find(H).removeAttr("lay-sort"),
    ...
    F.prototype.fullSize = function () {
        ...
        i = t.config,
        a = i.height;
        t.fullHeightGap && (a = z.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)),
    ...
    F.prototype.events = function () {
        ...
        i.layTool.on("click", "*[lay-event]", function (e) {
            ...
            case "LAYTABLE_EXPORT":
                ...
                break;
                case "LAYTABLE_PRINT":
                if ("function" == typeof a.print.func) {
                    a.print.func(i);
                    break
                }
                let c = "";
                ...
                u.document.write(h + a.print.preHtml + v.prop("outerHTML") + a.print.suffixHtml),
                u.document.close(),
                u.print(),
                u.close()
            }
        ...
        }).find(H + " .layui-edge ").on("click", function (e) {
            var a = t(this),
            l = a.index(),
        ...
        i.layBody.on("mouseenter", "tr", function () {
            var e = t(this),
            a = e.index();
            e.data("off") || i.layBody.find("tr:eq(" + a + ")").addClass(R)
        }).on("mouseleave", "tr", function () {
            var e = t(this),
            a = e.index();
            e.data("off") || i.layBody.find("tr:eq(" + a + ")").removeClass(R)
        ...
        i.layBody.on("change", "." + S, function () {
            var e = t(this),
            a = this.value,
        ...
        i.layBody.on("click", "td", function (e) {
            ...
            l = i.children(h);
            if (!i.data("off") && a) {
                var n = t('<input class="layui-input ' + S + '">');
                return n[0].value = i.data("content") || l.text(),
                i.find("." + S)[0] || i.append(n),
                n.focus(),
                void layui.stope(e)
            }
